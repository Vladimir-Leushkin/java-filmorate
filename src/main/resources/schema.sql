DROP TABLE IF EXISTS MPA, GENRES, FILMS, USERS, FILM_GENRES, FILM_LIKES, USER_FRIENDS, REVIEWS, REVIEWS_RATINGS;
...
(
    ...
    CONSTRAINT REVIEWS_RATINGS_ID_REVIEW_FK
        FOREIGN KEY (ID_REVIEW) REFERENCES REVIEWS (ID_REVIEW) ON DELETE CASCADE,
    CONSTRAINT REVIEWS_RATINGS_USERS_ID_FK
        FOREIGN KEY (USER_ID) REFERENCES USERS (USER_ID) ON DELETE CASCADE
);